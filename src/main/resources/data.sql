...
INSERT INTO users (username, password, enabled) values ('user', '{bcrypt}$2a$10$RWZaZ0TQboHTshM5OX6JJ.W7UhUzsGTxU.yZRsAOcPztLxdBnQYoe', true);
INSERT INTO users (username, password, enabled) values ('admin', '{bcrypt}$2a$10$RWZaZ0TQboHTshM5OX6JJ.W7UhUzsGTxU.yZRsAOcPztLxdBnQYoe', true);
